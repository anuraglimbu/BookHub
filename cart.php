	...
	<div class="card rounded-0 shadow">
		...
		<div class="card-footer text-end">
			...
			<?php if(isset($_SESSION['user']) && $_SESSION['user'] == true): ?>
				<a href="checkout.php" class="btn btn-dark rounded-0 px-2 my-2">Go To Checkout</a>
			<?php else: ?>
				<a href="user_login.php?direct=checkout" class="btn btn-dark rounded-0 px-2 my-2">Login To Checkout</a>
			<?php endif; ?>
			
				<a href="books.php" class="btn continue-shopping rounded-0 px-2 my-2">Continue Shopping</a>
